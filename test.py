...
if start:
    # Ensure dataset directory exists in the working folder
    ...
    #hierarchy is the relationship between contours like what are inner contours and outer contours 
        ...
        if best_score > 0.7:
            ...
            match_text="No References"
                    #writing image, text,     position, font,              font scale, color,thickness
        cv2.putText(display_frame, match_text,(10,30),cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 2) #displaying the match text on the frame
